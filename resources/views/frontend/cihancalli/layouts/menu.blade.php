                    ...
                    <div class="dropdown-menu dropdown-menu-end animated--fade-in-up me-lg-n25 me-xl-n15"
                        ...
                        <div class="row g-0">
                            <div
                                ...
                                style="background-image: url('https://zerdasoftware.com/zerdasoftware/dist/assets/img/backgrounds/bg-dropdown-xl.jpg')">
                            ...
                            <div class="col-lg-7 p-lg-5">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Mobile App</a>
                                        <a class="dropdown-item" href="{{route('homepage')}}">Web App</a>

                                        <div class="dropdown-divider border-0"></div>
                                        <h6 class="dropdown-header text-primary">General</h6>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Blog</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">English</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Career</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Crypto</a>

                                        <div class="dropdown-divider border-0"></div>

                                        <h6 class="dropdown-header text-primary">Project & Program</h6>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Android Studio</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Visual Studio Code</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">PHP Storm</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Figma</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Adobe XD</a>

                                        <div class="dropdown-divider border-0 d-lg-none"></div>
                                    </div>
                                    <div class="col-lg-6">

                                        <h6 class="dropdown-header text-primary">Github & Library</h6>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Github</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Bitbucket</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Jira</a>

                                        <div class="dropdown-divider border-0"></div>
                                        <h6 class="dropdown-header text-primary">Technology & AI</h6>

                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">Chat GBT</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">OPEN AI</a>
                                        <a class="dropdown-item" href="{{route('homepage').'/blog/'}}">DALL-E
                                            <span class="badge bg-primary-soft text-primary ms-1">2</span>
                                        </a>
