            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-10 col-xl-8">
                    <div class="single-post">
                        ...
                        <p class="lead">{{$page->post_summary}}</p>
                            ...
                            <div class="single-post-meta me-4">
                                ...
                                <div class="single-post-meta-details">
                                    ...
                                    <div class="col post-preview-meta-details-date">
                                        <span class="badge bg-success text-white"><i class="fa-regular fa-clock"></i> {{\Carbon\Carbon::parse($page->created_at)->format('d.m.Y')}}</span>
                                        <span class="badge bg-info text-white"><i class="fa-solid fa-eye"></i>  0</span>
                                        <a href=""><span
                                                class="badge bg-secondary text-white">{{$page->page_title}}</span></a>
                                    </div>
                                </div>
                            </div>
                            <!--
                        ...
                        <img class="img-fluid mb-2 rounded" src="{{$page->imageUrl}}"/>
                        <!--
                        ...
                        <div class="single-post-text my-5">
                            {!!$page->page_content!!}
                            <hr class="my-5"/>
                            <div class="text-center"><a class="btn btn-transparent-dark" href="{{route('homepage')}}">Back
                                    to Homepage</a></div>
                        </div>
                    </div>
                </div>
